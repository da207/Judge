...
public:
    ...
    void setupUi(QMainWindow *StartWindow)
    {
        ...
        StartButton->setGeometry(QRect(800, 410, 251, 71));
        StartButton->setStyleSheet(QLatin1String("border-image: url(:/image/StartButton.jpg);\n"
"border-image: url(:/image/StartButton.jpg);"));
    ...
    void retranslateUi(QMainWindow *StartWindow)
    {
        ...
        StartButton->setText(QApplication::translate("StartWindow", "...", Q_NULLPTR));
